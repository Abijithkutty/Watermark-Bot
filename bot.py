...
# Support Group: @tamilblasterzzzz 
# Bots Channel: @REX_BOTZ
...
async def HelpWatermark(bot, cmd):
	...
	await cmd.reply_text(
		...
		parse_mode="Markdown",
		reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/REX_BOTZ"), InlineKeyboardButton("Support Group", url="https://t.me/moviesworld2ty")], [InlineKeyboardButton("Bots Channel", url="https://t.me/Discovery_Updates")], [InlineKeyboardButton("Source Code", url="https://github.com/AbirHasan2005/Watermark-Bot")]]),
...
async def button(bot, cmd: CallbackQuery):
	...
	if "refreshmeh" in cb_data:
		...
		await cmd.message.edit(
			text=Config.USAGE_WATERMARK_ADDER,
			parse_mode="Markdown",
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/REX_BOTZ"), InlineKeyboardButton("Support Group", url="https://t.me/moviesworld2ty")], [InlineKeyboardButton("Bots Channel", url="https://t.me/REX_BOTZ")]]),
			disable_web_page_preview=True
		)
